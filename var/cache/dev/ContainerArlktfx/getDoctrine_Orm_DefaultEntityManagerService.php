...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ForumBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ActualiteBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\EventsBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\ReclamationBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\GererEnfantBundle\\Entity')]);

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'ForumBundle\\Entity');
$b->addDriver($c, 'ActualiteBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'ForumBundle' => 'ForumBundle\\Entity', 'ActualiteBundle' => 'ActualiteBundle\\Entity', 'EventsBundle' => 'EventsBundle\\Entity', 'ReclamationBundle' => 'ReclamationBundle\\Entity', 'GererEnfantBundle' => 'GererEnfantBundle\\Entity']);
